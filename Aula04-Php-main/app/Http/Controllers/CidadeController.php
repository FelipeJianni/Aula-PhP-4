...
class CidadeController extends Controller {
    ...
    public function show($id)
    {
       ...
       // Armazena os dados do cidade para o índice obtido
       $dados = $aux[$indice];
       
       // retorna a "view" e passa os dados do cidade
    ...
    {
         // Cria o array com os novos dados do cidade
       $alterado = [
        'id' => $id,
        'nome' => $request->nome,
        'porte' => $request->porte
        ...
        // Substitui os dados do cidade com as novas informações
        $aux[$indice] = $alterado;
